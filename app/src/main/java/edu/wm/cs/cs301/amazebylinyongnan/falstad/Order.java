...
public interface Order {
    ...
    /**
     * Notify controller when the maze has been delivered and ready to
     * start Play Activity.
     */
    void notifyController();

	void storeMaze(int width, int height, int rooms, int expected_partiters, BSPNode root, Cells cells, int[][] dists, int startX, int startY);
}
