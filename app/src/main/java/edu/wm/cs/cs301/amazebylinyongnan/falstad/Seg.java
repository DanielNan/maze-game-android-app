...
import edu.wm.cs.cs301.amazebylinyongnan.falstad.MazeFileWriter;
import edu.wm.cs.cs301.amazebylinyongnan.falstad.MazePanel;
...
public class Seg {
	...
	public Seg(int psx, int psy, int pdx, int pdy, int distance, int cc) {
		...
		//before determine the color, initialize in the MazePanel so that panel can set the color without awt.
	...
	public void storeSeg(Document doc, Element mazeXML, int number, int i) {
		...
		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, panel.getSegColor().getColor()) ;
	}
	...
	public boolean equals(Object other){
		...
		if ((x != o.x) || (dx != o.dx) ||(y != o.y) || (dy != o.dy)) 
			return false ; 
		if ((dist != o.dist) || (partition != o.partition) ||(seen != o.seen) || (panel.getSegColor().getColor() != o.panel.getSegColor().getColor()))
			return false ;
	...
	*/
	...
	public void setColor(int r, int g, int b) {
		...
		//save the color to the field of a new instance of panel object
		//access that color with a getter method.
		panel.setSegColor(r,g,b);
		//this.col = color;
	}
	
	public void setColorWithOneParameter(int i){
		panel.segSetColorWithOneParameter(i);
	}
